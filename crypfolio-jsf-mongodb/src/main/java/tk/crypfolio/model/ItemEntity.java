...
public class ItemEntity implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        return getId().equals(that.getId()) &&
                ...
                getPortfolio().getId().equals(that.getPortfolio().getId()) &&
                getCoin().getId().equals(that.getCoin().getId());
    }
    ...
    public int hashCode() {
        return Objects.hash(getId(), getAmount(), getShowedCurrency(), getNetCostUsd(), getNetCostEur(),
                ...
                getAverageBoughtPriceBtc(), getAverageBoughtPriceEth(), getPortfolio().getId(), getCoin().getId());
    }
